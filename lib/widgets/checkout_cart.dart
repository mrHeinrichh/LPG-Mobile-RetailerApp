                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Flexible(
                          child: Text(
                            cartItem.retailerPrice * cartItem.stock % 1 == 0
                                ? '₱${(cartItem.retailerPrice * cartItem.stock).toInt().toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match match) => '${match[1]},')}'
                                : '₱${(cartItem.retailerPrice * cartItem.stock).toStringAsFixed(2).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match match) => '${match[1]},')}',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 18,
                              color: const Color(0xFFd41111).withOpacity(0.8),

        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 5),
              const Text(
                "• The system grants you an exclusive, non-transferable access of the application for your personal and non-commercial use as a retailer. You may not use the application for any illegal or unauthorized purpose. You may not reproduce, distribute, modify, create derivative works of, or publicly display the applicaton without the prior written consent of the shop.",
                style: TextStyle(
                  fontSize: 15.0,
                ),
                textAlign: TextAlign.justify,

...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> fetchAndAddMessages(
      String? fromUserId, String toretailerId) async {
    if (fromUserId != null) {
      List<Map<String, dynamic>> messages =
          await fetchMessagesForretailer(fromUserId, toretailerId);
  ...
  Future<List<Map<String, dynamic>>> fetchMessagesForretailer(
      String fromUserId, String toretailerId) async {
    final filter = {
      "\$or": [
        {"from": fromUserId, "to": toretailerId},
        {"from": toretailerId, "to": fromUserId}
      ]
    };
    ...
    if (response.statusCode == 200) {
      ...
      if (data['status'] == 'success') {
        ...
        print('Failed to fetch messages for retailer $toretailerId');
        return [];
      }
    } else {
      print(
          'Failed to fetch messages for retailer $toretailerId. Status code: ${response.statusCode}');
      return [];
    }
  }
